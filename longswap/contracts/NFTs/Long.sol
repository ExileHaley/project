...
contract Long is ERC721{
    ...
    function _addHoldInfo(address holder,uint256 tokenId) internal{
        holdInfo[holder].push(tokenId);
        index[holder][tokenId] = holdInfo[holder].length - 1;
    }
