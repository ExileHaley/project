...
contract Kabosu is ERC20{
    ...
    address admin;
    uint256 marketingRate = 28;
    uint256 fundationRate = 12;
    uint256 deadRate = 10;
    ...
    //receiver:0x0aA540c88576A555C1974B2731a95DFc5D4941De
    //marketing:0xf7DFE4b1992C004D19e08bb4E033243760575d93
    //fundation:0x9c5787cae8189b8c93E793AF43F1979ceacaBa93
    constructor(address _receiver,address _marketing,address _fundation)ERC20("KABOSU","KABOSU"){
        _mint(_receiver, 10000000e18);
    ...
    function setTrading() external onlyAdmin(){
        openTrading = true;
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual override{
        ...
        if(trading && from != address(this)) {
            require(openTrading, "no open trading!");
